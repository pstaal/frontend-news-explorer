        ...
        return (
            <section className="cardlist">
                <div className="cardlist__container">
                    ...
                    {filteredCards.map((card, index) => <NewsCard openModal={props.openModal} articles={props.articles} deleteCard={props.deleteCard} saveCard={props.saveCard} searchTerm={props.searchTerm} isLoggedIn={props.isLoggedIn} key={index} article={card}/>)}
                </div>
